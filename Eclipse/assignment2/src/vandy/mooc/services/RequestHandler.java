...
class RequestHandler extends Handler {
    ...
    public void handleMessage(Message message) {
        ...
        final Messenger replyMsgr = requestMessage.getMessenger();
        ...
        final Runnable downloadImageAndReply = 
            new Runnable() {
                ...
                public void run() {
                    ...
                    // TODO -- you fill in here.
                    Uri result = Utils.downloadImage(mService.get(), url, directoryPath);

                    // Send the path to the image file, url, and
                    // requestCode back to the Activity via the
                    // replyMessenger.
                    // TODO -- you fill in here.
                    /*Message replyMessage = ReplyMessage.makeReplyMessage(result, uri, requestCode);
                    try {
                        replyMsgr.send(replyMessage);
                    }
                    catch (RemoteException ex) {

                    }*/
                    sendPath(replyMsgr, result, url, requestCode);
                }
            };
